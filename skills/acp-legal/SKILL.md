---
name: acp-legal
description: Use when the user wants legal/policy pages for their ACP store via the Claude connector — Terms of Use, Privacy Policy, Shipping Policy, Return/Refund Policy, or Cookie Policy. Triggers on "terms of use", "terms and conditions", "privacy policy", "cookie policy", "shipping policy", "legal pages", "generate my policies", "add terms to my store", "publish privacy policy". Drives generate_legal_policies, list_legal_policies, get_legal_policy, set_legal_policy, publish_legal_policy.
---
