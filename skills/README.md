...
| `acp-cohorts` | Cohort intelligence (ML micro-cohorts, hot/warm/cold, recommendations) | `recompute_cohorts`, `list_cohorts`, `customer_cohorts`, `customer_recommendations` |
