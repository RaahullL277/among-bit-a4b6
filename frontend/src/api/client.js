...
export const api = {
  ...
  catalog: {
    ...
    removeCollection: (id) => request(`/catalog/collections/${id}`, { method: 'DELETE' }),
    setProductCollections: (productId, collectionIds) => request(`/catalog/products/${productId}/collections`, { method: 'PUT', body: { collectionIds } }),
    getOptions: (productId) => request(`/catalog/products/${productId}/options`),
    setOptions: (productId, options) => request(`/catalog/products/${productId}/options`, { method: 'PUT', body: { options } }),
    getAttributes: (productId) => request(`/catalog/products/${productId}/attributes`),
    setAttributes: (productId, attributes) => request(`/catalog/products/${productId}/attributes`, { method: 'PUT', body: { attributes } }),
    listAssets: (productId) => request(`/catalog/products/${productId}/assets`),
    addAsset: (productId, body) => request(`/catalog/products/${productId}/assets`, { method: 'POST', body }),
    removeAsset: (id) => request(`/catalog/assets/${id}`, { method: 'DELETE' }),
    getTiers: (variantId) => request(`/catalog/variants/${variantId}/price-tiers`),
    setTiers: (variantId, tiers) => request(`/catalog/variants/${variantId}/price-tiers`, { method: 'PUT', body: { tiers } }),
    listImages: (productId) => request(`/catalog/products/${productId}/images`),
    addImage: (body) => request('/catalog/images', { method: 'POST', body }),
    setPrimaryImage: (id) => request(`/catalog/images/${id}/primary`, { method: 'POST' }),
    reorderImages: (productId, orderedIds) => request(`/catalog/products/${productId}/images/reorder`, { method: 'PUT', body: { orderedIds } }),
    removeImage: (id) => request(`/catalog/images/${id}`, { method: 'DELETE' }),
  },
  listing: {
